 ...
 */
package study.book.systemdesign.consistenthash.sample;
...
import study.book.systemdesign.consistenthash.ConsistentHashRouter;

/**
 * a test sample to test the hash function
 * routing distribution,
 * by default ConsistentHashRouter will use a inner MD5 hash algorithm
 *
 */
public class DistributionTestSample{
    ...
    public static void main(String[] args) {
        ...
        ConsistentHashRouter<MyServiceNode> consistentHashRouter = new ConsistentHashRouter<>(
                Arrays.asList(node1,node2,node3,node4),20);//20 virtual node
